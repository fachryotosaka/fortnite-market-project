                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(count($hero->getMedia('news'))  > 0)
                                    <a href="{{ $hero->getMedia('news')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $hero->getMedia('news')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('edit-news', $hero->id) }}" class="btn btn-info">
                                             <i class="fa fa-pencil"></i>
                                        </a>


                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-news', $hero->id) }}" method="post">
                                            @csrf
                                            @method('delete')
