        ...
        <div class="col-12 grid-margin stretch-card">
          <div class="card">
            <div class="card-body">
              ...
              <form class="forms-sample" action="/main-update/{{ $main->id }}" method="POST">
                @csrf
                @method('put')

                <div class="form-group">
                  <label for="exampleInputName1">Name</label>
                  <input type="text" class="form-control" id="exampleInputName1" name="name" placeholder="Name" value="{{ old('name', $main->name) }}">
                </div>
...
<script>
 ...
 @if(isset($main) && $main->getMedia('main'))
       var files =
         {!! json_encode($main->getMedia('main')) !!}
           for (var i in files) {
           var file = files[i]
