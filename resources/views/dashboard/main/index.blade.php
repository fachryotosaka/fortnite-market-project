                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(count($hero->getMedia('main'))  > 0)
                                    <a href="{{ $hero->getMedia('main')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $hero->getMedia('main')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('edit-main', $hero->id) }}" class="btn btn-info">
                                             <i class="fa fa-pencil"></i>
                                        </a>


                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-main', $hero->id) }}" method="post">
                                            @csrf
                                            @method('delete')
