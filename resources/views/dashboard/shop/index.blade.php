...
<div class="main-panel">
    <div class="content-wrapper">
      ...
      <div class="btn-group bg-white p-3" role="group" aria-label="Basic example">
        <a href="{{ url('/download') }}" type="button" class="btn btn-link text-dark py-0 ">Download</a>
      </div>
      <div class="row">
        <div class="col-md-12">
                        ...
                        <table class="table table-hover">
                          ...
                          <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if(count($hero->getMedia('shops'))  > 0)
                                    <a href="{{ $hero->getMedia('shops')->first()->getUrl() }}" target="_blank">
                                        <img src="{{ $hero->getMedia('shops')->first()->getUrl() }}" width="100px" height="50px" alt="">
                                    </a>
                                    @else
                                ...
                                <td>
                                    ...
                                    <div class="btn-group">
                                        <a href="{{ route('edit-shop', $hero->id) }}" class="btn btn-info">
                                             <i class="fa fa-pencil"></i>
                                        </a>


                                        <form onclick="return confirm('are you sure ?');" action="{{ route('destroy-shop', $hero->id) }}" method="post">
                                            @csrf
                                            @method('delete')
